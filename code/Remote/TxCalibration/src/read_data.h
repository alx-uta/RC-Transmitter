...
void readJoysticks() {
  ...
  joystick_x1_map = joystickMap(
    joystick_x1,
    left_joystick_min_value_x + left_joystick_drift_value_x,
    left_joystick_max_value_x - left_joystick_drift_value_x,
  ...
  joystick_y1_map = joystickMap(
    joystick_y1,
    left_joystick_min_value_y + left_joystick_drift_value_y,
    left_joystick_max_value_y - left_joystick_drift_value_y,
  ...
  joystick_x2_map = joystickMap(
    joystick_x2,
    right_joystick_min_value_x + right_joystick_drift_value_x,
    right_joystick_max_value_x - right_joystick_drift_value_x,
  ...
  joystick_y2_map = joystickMap(
    joystick_y2,
    right_joystick_min_value_y + right_joystick_drift_value_y,
    right_joystick_max_value_y - right_joystick_drift_value_y,
  ...
  payload.structure.j1x = (
    joystick_x1 > left_joystick_middle_value_x + left_joystick_drift_value_x || joystick_x1 < left_joystick_middle_value_x - left_joystick_drift_value_x
  ) ? joystick_x1_map : joystick_default_value;

   payload.structure.j1y = (
    joystick_y1 > left_joystick_middle_value_y + left_joystick_drift_value_y || joystick_y1 < left_joystick_middle_value_y - left_joystick_drift_value_y
  ) ? joystick_y1_map : joystick_default_value;
  
  // Right Joystick
  payload.structure.j2x = (
    joystick_x2 > right_joystick_middle_value_x + right_joystick_drift_value_x || joystick_x2 < right_joystick_middle_value_x - right_joystick_drift_value_x
  ) ? joystick_x2_map : joystick_default_value;
  
  payload.structure.j2y = (
    joystick_y2 > right_joystick_middle_value_y + right_joystick_drift_value_y || joystick_y2 < right_joystick_middle_value_y - right_joystick_drift_value_y
