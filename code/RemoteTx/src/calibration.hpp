...
void joysticksDriftMiddleValue() {
  ...
  for (int j = 0; j < numJoysticks; j++) {
    ...
    Serial.print(" X: ");
    Serial.print(total_values[j][0] / calibrationReadings);
    Serial.print(": Y: ");
    Serial.print(total_values[j][1] / calibrationReadings);
    Serial.println();
  }
  ...
  for (int j = 0; j < numJoysticks; j++) {
    Serial.print(j == 0 ? "Left Joystick:" : "Right Joystick:");
    Serial.print(" X: ");
    Serial.print(max_values[j][0] - (total_values[j][0] / calibrationReadings));
    Serial.print(": Y: ");
    Serial.print(max_values[j][1] - (total_values[j][1] / calibrationReadings));
    Serial.println();
  }
...
void potentiometersCalibration() {
    ...
    for (int iteration = 0; iteration < calibrationReadings; iteration++) {
